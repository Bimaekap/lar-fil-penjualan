    ...
    <div class="login-outer-container">
        <div class="login-container">
            <div class="login-area">
                ...
                <form class="login-items" action="{{ route('login.post') }}" method="POST">
                    @csrf
                ...
                <p class="p">
                    Belum Punya Akun?
                    <a class="a" href="{{ route('buyer.register') }}">Buat Akun Baru</a>
                </p>
                {{-- <a class='a' href="{{ route('website.frontend') }}">Belanja</a> --}}
