        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <p class="breadcrumb-item text-dark" href="#">Shop</p>
                </nav>
            </div>
        </div>
    </div>
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">{{ $order->jumlah }}</td>
                            <td class="align-middle">Rp. {{ $order->total }}</td>
                            <td class="align-middle">{{ $order->no_pesanan }}</td>

                            <td class="align-middle" cursor="pointer">
                                {{-- data:image/png;base64,{{DNS2D::getBarcodePNG($order->no_pesanan, 'QRCODE',22,22)}}
                                --}}
                                <a style="w-10 h-10" href="{{url('storage/'.$order->qr_code)}}.png"
                                    download="no_pesanan{{ $order->no_pesanan }}">
                                    <img src="data:image/png;base64,<?php echo DNS2D::getBarcodePNG($order->no_pesanan,'QRCODE')?>"
                                        alt=" barcode" />;
                                </a>
                            </td>
                        </tr>
